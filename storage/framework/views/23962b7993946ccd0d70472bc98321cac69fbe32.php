...
<body class="preload term-condition-page start-selling">
    ...
    <section class="hero-area bgimage">
        <div class="bg_image_holder">
            <img src="<?php echo e(url('/')); ?>/public/assets/images/start-selling1.jpg" alt="<?php echo e($allsettings->site_title); ?>">
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="hero__content__title">
                                ...
                                <a href="<?php echo e(url('/register')); ?>" class="register-btn btn btn-lg btn--icon btn-ss btn-secondary md-login bg-red-primary">
                ...
                <div class="col-lg-6 col-md-6 mt-3 mb-3 pt-3 pb-3 right-border border-data">
                    <div class="icon">
                        <?php if($setting['setting']->box1_icon != ''): ?>
                            <img
                                src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->box1_icon); ?>"
                                alt="<?php echo e($setting['setting']->box1_title); ?>"
                ...
                <div class="col-lg-6 col-md-6 mt-3 mb-3 pt-3 pb-3 border-data">
                    <div class="icon">
                        <?php if($setting['setting']->box2_icon != ''): ?>
                            <img
                                src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->box2_icon); ?>"
                                alt="<?php echo e($setting['setting']->box2_title); ?>"
                                class="img-fluid icon-img"
                            >
                        <?php endif; ?>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 mt-3 mb-3 pt-3 pb-3 right-border">
                    <div class="icon">
                        <?php if($setting['setting']->box3_icon != ''): ?>
                            <img
                                src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->box3_icon); ?>"
                                alt="<?php echo e($setting['setting']->box3_title); ?>"
                                class="img-fluid icon-img"
                            >
                        <?php endif; ?>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 mt-3 mb-3 pt-3 pb-3 ">
                    <div class="icon">
                        <?php if($setting['setting']->box4_icon != ''): ?>
                            <img
                                src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->box4_icon); ?>"
                                alt="<?php echo e($setting['setting']->box4_title); ?>"
                                class="img-fluid icon-img"
                            >
                        <?php endif; ?>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 mt-3 mb-3 pt-3 pb-3 right-border">
                    <div class="icon">
                        <?php if($setting['setting']->box5_icon != ''): ?>
                            <img
                                src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->box5_icon); ?>"
                                alt="<?php echo e($setting['setting']->box5_title); ?>"
                                class="img-fluid icon-img"
                            >
                        <?php endif; ?>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 mt-3  mb-3 pt-3 pb-3 right-border">
                    <div class="icon">
                        <?php if($setting['setting']->box6_icon != ''): ?>
                            <img
                                src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->box6_icon); ?>"
                                alt="<?php echo e($setting['setting']->box6_title); ?>"
                                class="img-fluid icon-img"
                            >
                        <?php endif; ?>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 mt-3 mb-3 pt-3 pb-3">
                    <div class="icon">
                        <?php if($setting['setting']->box7_icon != ''): ?>
                            <img
                                src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->box7_icon); ?>"
                                alt="<?php echo e($setting['setting']->box7_title); ?>"
                                class="img-fluid icon-img"
                            >
                        <?php endif; ?>
                    </div>
        ...
        <div class="container">
            <div class="row border-bottom features">
                <div class="col-lg-12 col-md-12 mt-3 mb-3 pt-3 pb-3">
                    ...
                    <div><?php echo html_entity_decode($setting['setting']->content_text_one); ?></div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row border-bottom features">
                <div class="col-lg-12 col-md-12 mt-3 mb-3 pt-3 pb-3">
                    ...
                    <div><?php echo html_entity_decode($setting['setting']->content_text_two); ?></div>
                </div>
        ...
        <div class="container">
            <div class="row border-bottom features">
                <div class="col-lg-12 col-md-12 mt-3 mb-3 pt-3 pb-3">
                    ...
                    <div><?php echo html_entity_decode($setting['setting']->content_text_three); ?></div>
                </div>
            </div>
        </div>
    </section>
...
<?php endif; ?>
<?php /**PATH /home/gotemplate/public_html/resources/views/start-selling.blade.php ENDPATH**/ ?>