                                ...
                                <div class="upload_modules module--upload">
                                    ...
                                    <div class="modules__content">
                                        <div class="form-group">
                                            <div class="upload_wrapper">
                                                <p class="label"><?php echo e(Helper::translation(2943,$translate)); ?> <sup>*</sup>
                                                    <span>(<?php echo e(Helper::translation(2946,$translate)); ?> : 255x165px)</span>
                                                </p>
                                        ...
                                        <div class="form-group">
                                            <div class="upload_wrapper">
                                                <p class="label"><?php echo e(Helper::translation(2945,$translate)); ?> <sup>*</sup>
                                                    <span>(<?php echo e(Helper::translation(2946,$translate)); ?> : 350x235px)</span>
                                                </p>
                                        ...
                                        <div class="form-group mb-0 pb-0">
                                            <div class="upload_wrapper">
                                                <p class="label"><?php echo e(Helper::translation(2950,$translate)); ?>
                                                    ...
                                                    <span>(<?php echo e(Helper::translation(2946,$translate)); ?> : 700x400px)</span>
                                                </p>
                                        ...
                                        <div id="youtube" <?php if($edit['item']->video_preview_type == 'youtube'): ?> class="form-group force-block" <?php else: ?> class="form-group force-none" <?php endif; ?>>
                                            ...
                                            <input type="text" id="video_url" name="video_url" class="text_field" data-bvalidator="required" value="<?php echo e($edit['item']->video_url); ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea type="text" id="regular_licence" name="regular_licence" class="text_field"><?php echo $edit['item']->regular_licence; ?></textarea>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea type="text" id="extended_licence" name="extended_licence" class="text_field"><?php echo $edit['item']->extended_licence; ?></textarea>
                                                        <p>After single service, do line separator using commas</p>
                                                    </div>
                                                </div>
                                            </div>
...
<?php endif; ?>
<?php /**PATH /home/gotemplate/public_html/resources/views/edit-item.blade.php ENDPATH**/ ?>