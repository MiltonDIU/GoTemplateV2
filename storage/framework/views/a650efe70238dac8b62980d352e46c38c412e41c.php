                   ...
                   <li class="menu-item-has-children dropdown">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/ssl-transaction')); ?>">Ssl Transaction</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="<?php echo e(url('/admin/exclusive-vendor-request')); ?>"> <i class="menu-icon fa fa-money"></i>Exclusive Vendor Request</a>
                    </li>
                    <li class="menu-item-has-children dropdown">
...
<?php /**PATH /home/gotemplate/public_html/resources/views/admin/navigation.blade.php ENDPATH**/ ?>