    ...
    <div id="demo">
        <section class="hero-area bgimage">
            <div class="bg_image_holder">
                <img
                    src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($allsettings->site_banner); ?>"
                        ...
                        <aside class="sidebar product--sidebar">
                            ...
                            <div class="sidebar-card card--slider">
                                <a class="card-title" href="#collapse3" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="collapse3">
                                    <h4>
                                        <?php echo e(Helper::translation(3183,$translate)); ?>
...
<?php endif; ?>
<?php /**PATH /home/gotemplate/public_html/resources/views/shop.blade.php ENDPATH**/ ?>