                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <?php $__currentLoopData = $itemData['item']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($order->payment_type == 'localbank' && $order->payment_status == 'pending'): ?>
                                                    <a href="orders/<?php echo e(base64_encode($order->purchase_token)); ?>" class="blue-color"onClick="return confirm('Are you sure click to complete payment?');">
...
<?php /**PATH /home/gotemplate/public_html/resources/views/admin/orders.blade.php ENDPATH**/ ?>