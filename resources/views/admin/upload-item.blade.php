                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea type="text" id="regular_licence" name="regular_licence" class="form-control"></textarea>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea type="text" id="extended_licence" name="extended_licence" class="form-control"></textarea>
                                                    </div>
                                                    <p>After single service, do line separator using commas</p>
                                                </div>
