                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Sold Level 1 ({{ $allsettings->site_currency }})<span class="require">*</span></label><br/>
                                             ...
                                             <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Sold Level 2 ({{ $allsettings->site_currency }})<span class="require">*</span></label><br/>
                                              ...
                                              <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Sold Level 3 ({{ $allsettings->site_currency }})<span class="require">*</span></label><br/>
                                             ...
                                             <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Sold Level 4 ({{ $allsettings->site_currency }})<span class="require">*</span></label><br/>
                                             ...
                                             <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Sold Level 5 ({{ $allsettings->site_currency }})<span class="require">*</span></label><br/>
                                             ...
                                             <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Sold Level 6+ ({{ $allsettings->site_currency }})<span class="require">*</span></label><br/>
                                             ...
                                             <div class="form-group">
                                               ...
                                               <input id="author_sold_level_six_label" name="author_sold_level_six_label" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->author_sold_level_six_label }}" placeholder="Power Elite Author" required>
                                             </div>
