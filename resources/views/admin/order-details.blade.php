                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    @foreach($itemData['item'] as $order)
                                        <tr>
                                            ...
                                            <td><a href="{{ URL::to('/user') }}/{{ \Feberr\User::getUserName($order->user_id)->username }}" target="_blank" class="blue-color">{{ \Feberr\User::getUserName($order->user_id)->username }}</a></td>
