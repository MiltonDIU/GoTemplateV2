                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                       @if($demo_mode == 'on')
                           ...
                           @else
                       <form action="{{ route('admin.edit-vendor') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="mobile" name="mobile" type="text" class="form-control" value="{{ $edit['userdata']->mobile }}">
                                        </div>
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    <label for="earnings" class="control-label mb-1">Earnings ({{ $allsettings->site_currency }})</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @foreach(Feberr\User::IS_MANUAL_VENDOR_RADIO as $key => $label)
                                                <div class="form-check {{ $errors->has('verified') ? 'is-invalid' : '' }}">
                                                    <input class="form-check-input" type="radio" id="verified{{ $key }}" name="verified" value="{{ $key }}" {{$edit['userdata']->verified==(string) $key ? 'checked' : ''}} required>
                                                    <label class="form-check-label" for="verified{{ $key }}">{{ $label }}</label>
                                                </div>
                                            @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            @foreach(Feberr\User::IS_ACTIVE_RADIO as $key => $label)
                                                <div class="form-check {{ $errors->has('exclusive_author') ? 'is-invalid' : '' }}">
                                                    <input class="form-check-input" type="radio" id="exclusive_author{{ $key }}" name="exclusive_author" value="{{ $key }}" {{$edit['userdata']->exclusive_author==(string) $key ? 'checked' : ''}} required>
                                                    <label class="form-check-label" for="exclusive_author{{ $key }}">{{ $label }}</label>
                                                </div>
                                            @endforeach
                                            @if($errors->has('exclusive_author'))
                                                <div class="invalid-feedback">
                                                    {{ $errors->first('exclusive_author') }}
                                                </div>
                                            @endif
                                        </div>
