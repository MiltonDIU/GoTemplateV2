            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="fa fa-user"></i><a href="{{ url('/admin/admin-list') }}">Admin</a></li>
                ...
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-location-arrow"></i>Item Settings</a>
                    <ul class="sub-menu children dropdown-menu">
...
{{--                <li><a href="{{ url('/admin/items') }}"> <i class="menu-icon fa fa-paper-plane"></i>Items</a></li>--}}

                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-location-arrow"></i>Items ({{ \Feberr\Helpers\Helper::itemCount() }})</a>
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-paper-plane"></i><a href="{{ url('/admin/items') }}">All ({{ \Feberr\Helpers\Helper::itemCount() }})</a></li>
                        <li><i class="menu-icon fa fa-paper-plane"></i><a href="{{ url('/admin/approve-items') }}">Approve ({{ \Feberr\Helpers\Helper::itemApproveCount() }})</a></li>
                        <li><i class="menu-icon fa fa-paper-plane"></i><a href="{{ url('/admin/un-approve-items') }}">Pending ({{ \Feberr\Helpers\Helper::itemPendingCount() }})</a></li>
                        <li><i class="menu-icon fa fa-paper-plane"></i><a href="{{ url('/admin/rejected-items') }}">Rejected ({{ \Feberr\Helpers\Helper::itemRejectCount() }})</a></li>
                        <li><i class="menu-icon fa fa-paper-plane"></i><a href="{{ url('/admin/flash-request-items') }}">Flash Request ({{ \Feberr\Helpers\Helper::itemFlashRequestCount() }})</a></li>
                        <li><i class="menu-icon fa fa fa-paper-plane"></i><a href="{{ url('/admin/free-items') }}">Free ({{ \Feberr\Helpers\Helper::itemFreeCount() }})</a></li>
                    </ul>
                </li>

                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-location-arrow"></i>Orders ({{ \Feberr\Helpers\Helper::orderCount() }})</a>
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-paper-plane"></i><a href="{{ url('/admin/orders') }}">All ({{ \Feberr\Helpers\Helper::orderCount() }})</a></li>
                        <li><i class="menu-icon fa fa-paper-plane"></i><a href="{{ url('/admin/payment-orders') }}">Payment ({{ \Feberr\Helpers\Helper::paymentOrderCount() }})</a></li>
                        <li><i class="menu-icon fa fa-paper-plane"></i><a href="{{ url('/admin/pending-orders') }}">Pending ({{ \Feberr\Helpers\Helper::pendingOrderCount() }})</a></li>
                        <li><i class="menu-icon fa fa fa-paper-plane"></i><a href="{{ url('/admin/free-orders') }}">Free ({{ \Feberr\Helpers\Helper::freeOrderCount() }})</a></li>
                    </ul>
                </li>
...
{{--                <li><a href="{{ url('/admin/orders') }}"> <i class="menu-icon fa fa-paper-plane"></i>Orders</a></li>--}}
                ...
                <li>
                    <a href="{{ url('/admin/exclusive-vendor-request') }}"> <i class="menu-icon fa fa-money"></i>Exclusive Vendor Request</a>
                </li>
                <li class="menu-item-has-children dropdown">
