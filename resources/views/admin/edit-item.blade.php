                                          ...
                                          @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                        <textarea type="text" id="regular_licence" name="regular_licence" class="form-control">{!! $edit['item']->regular_licence !!}</textarea>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                        <textarea type="text" id="extended_licence" name="extended_licence" class="form-control">{!! $edit['item']->extended_licence !!}</textarea>
