                                    ...
                                    <div class="card-body">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <select name="attr_field_status" class="form-control" required>
                                                  <option value=""></option>
                                                  <option value="1" @if($edit['attribute']->attr_field_status == 1) selected @endif>Active</option>
                                                  <option value="0" @if($edit['attribute']->attr_field_status == 0) selected @endif>InActive</option>
                                                </select>
                                            </div>         
