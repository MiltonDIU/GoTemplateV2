                        ...
                        <div class="information__set toggle_module collapse show" id="collapse2">
                            <div class="information_wrapper form--fields">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="acname">Mobile Number
                                                <sup>*</sup>
                                            </label>
                                            <input type="text" id="mobile" name="mobile" class="text_field" placeholder="Mobile Number" value="{{ Auth::user()->mobile }}" data-bvalidator="required">
                                        </div>
                                    </div>
                                </div>
                                    <div class="row">
                                        ...
                                        <div class="select-wrap select-wrap2">
                                            <select name="country" id="country" class="text_field" data-bvalidator="required">
                                                ...
                                                @foreach($country['country'] as $country)
                                                    <option value="{{ $country->country_id }}" @if(Auth::user()->country == $country->country_id ) selected="selected" @endif>
