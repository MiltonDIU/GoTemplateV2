...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('public/preview/css/bootstrap.css') }}" type="text/css" />
  <link rel="stylesheet" href="{{ asset('public/preview/css/app.css') }}" type="text/css" />
  <link rel="stylesheet" href="{{ asset('public/preview/css/style.css') }}" type="text/css" />
</head>
...
<body>
  <div id="header-bar">
    <header id="header" class="navbar navbar-fixed-top bg-white-only box-shadow" data-spy="affix" data-offset-top="1">
      ...
      <ul class="nav navbar-nav text-center deskonly">
        <li>
          <div class="">
            <a href="{{ URL::to('/item') }}/{{ $item['item']->item_slug }}/{{ $item['item']->item_id }}" class="btn btn-md w-sm btn-success m-r-sm m-t-xxs"><strong>{{ Helper::translation(3074,$translate) }}</strong></a>
  ...
  <iframe 
    id="preview-frame" 
    class="w-full h-full" 
    src="{{ $item['item']->demo_url }}" 
    name="preview-frame" 
    frameborder="0" 
    noresize="noresize"
  ></iframe>

  <script src="{{ asset('public/preview/js/jquery.min.js') }}"></script>
  <script src="{{ asset('public/preview/js/bootstrap.js') }}"></script>
</body>
