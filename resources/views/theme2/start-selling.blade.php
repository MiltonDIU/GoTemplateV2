...
@section('content')
  ...
  <section id="selling_banner">
      <!-- container start -->
      <div class="container">
          <h1 class="page_banner_title">Become a Vendor and Sell on GoTemplate</h1>
          <h2 class="page_banner_description">Simple Application Process</h2>

          <div class="sale_page_button">
              <a href="{{ url('/register') }}">See How to Become a Vendor</a>
          </div>
      </div>
      <!-- container start -->
  </section>
  ...
  <section id="become_vendor">
      <!-- container start -->
      <div class="container">
          <h4 class="sale_title_big">Why you’ll be a Vendor</h4>
          ...
          <div class="sale_page_button">
              <a href="{{ url('register')}}">Become Exclusive Vendor</a>
          </div>
      </div>
      <!-- container end -->
  </section>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-4 col-sm-12 col-md-6 col-xl-4">
                      <div class="sale_item_box">
                          ...
                          <p class="sale_item_text">Become an author on GoTemplate and sell WordPress, WooCommerce, Joomla, Drupal, HTML, Bootstrap, Admin templates, Shopify, Opencart, Magento, PrestaShop templates, and much more. Your website templates will show off on our top category pages, receive sustainable traffic and sales.</p>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-sm-12 col-md-6 col-xl-4">
                      <div class="sale_item_box">
                          ...
                          <p class="sale_item_text">Created a plugin and want to share it with others? Make an upload through your author account and sell it on TemplateMonster digital marketplace. At the moment, we feature WordPress Plugins, PrestaShop Modules, Magento Extensions, JavaScript elements, and are open for new niches and suggestions.</p>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-sm-12 col-md-6 col-xl-4">
                      <div class="sale_item_box">
                          ...
                          <p class="sale_item_text">Are you a talented graphic designer? The digital marketplace is a perfect way to share the best works in your portfolio and sell them independently. Your logo design, fonts, CV templates, certificate designs, illustrations, and other graphics can appear on TemplateMonster shortly.</p>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-sm-12 col-md-6 col-xl-4">
                      <div class="sale_item_box">
                          ...
                          <p class="sale_item_text">Presentation templates are a great way for web and graphic designers to present their skills to the world. Be it PowerPoint, Keynote, or Google Slides format, feel free to submit your design, and let's see it in the listings.</p>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-sm-12 col-md-6 col-xl-4">
                      <div class="sale_item_box">
                          ...
                          <p class="sale_item_text">Have you made lots of stock video and audio files? Rest assured that you're sitting on a gold mine that will bring you a great passive income. Upload your stock media right now and start making a fortune.</p>
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-3 col-sm-12 col-md-6 col-xl-3">
                      <div class="sale_item_box">
                          ...
                          <p class="sale_item_text">The Vendors will facilitate the customers to achieve their needs by ensuring that their contents provide all the necessary tasks.</p>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-3 col-sm-12 col-md-6 col-xl-3">
                      <div class="sale_item_box">
                          ...
                          <p class="sale_item_text"> Vendors are expected to be open-minded and willing to learn from the working team of GoTemplate. This is necessary to ensure the quality of the contents.</p>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-3 col-sm-12 col-md-6 col-xl-3">
                      <div class="sale_item_box">
                          ...
                          <p class="sale_item_text">Vendors are expected to be willing to work on their contents based on the need of the customers. They need to be positive to work as per the request of the client if needed with a separate contract.</p>
                      </div>
                  </div>
