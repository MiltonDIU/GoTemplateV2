              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <textarea type="text" id="regular_licence" name="regular_licence" class="text_field">{!! $edit['item']->regular_licence !!}</textarea>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <textarea type="text" id="extended_licence" name="extended_licence" class="text_field">{!! $edit['item']->extended_licence !!}</textarea>
                      <p>After single service, do line separator using commas</p>
                    </div>
                  </div>
                </div>
