...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::get('/item/liked/{id}/{liked}', 'ItemController@view_likes_item')->name('item.liked');
  ...
  Route::get('/likes/{like_id}/{item_id}', 'ItemController@remove_likes_item')->name('item.liked.remove');
	...
	Route::get('/cancel', 'CommonController@payment_cancel')->name('cancel');
	Route::get('/fail', 'CommonController@payment_fail')->name('fail');
	Route::get('/success', 'ItemController@view_success')->name('success');
	...
	// reviews
	Route::get('/customer_reviews', 'CommonController@view_all_reviews');
});
...
//SSL Commerz Transaction List
	Route::get('/admin/ssl-transaction', 'Admin\ItemController@ssl_transaction');
    Route::get('admin/ssl-transaction-list','Admin\ItemController@get_transaction')->name('ssl_transaction.list');
    ...
    // Exclusive Vendor
    Route::get('/admin/exclusive-vendor-request', 'Admin\ItemController@viewExclusiveVendorRequest');
    Route::get('/admin/exclusive-vendor-request-approve/{id}', 'Admin\ItemController@viewExclusiveVendorRequestAppoved');
