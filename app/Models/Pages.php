...
class Pages extends Model
{
  ...
  public static function menupageData()
  {
    ...
    $value=DB::table('pages')->where('page_status','=','1')->where('main_menu','=','1')->where('page_id','!=',13)->orderBy('menu_order', 'asc')->get();
    return $value;
  ...
  public static function footermenuData()
  {
    ...
    public static function copyRightMenuData()
    {
        $value=DB::table('pages')->where('page_status','=','1')->where('copyright_menu','=','1')->orderBy('menu_order', 'asc')->get();
        return $value;
    }
  ...
  public static function editpageData($page_id){
