...
class CategoryController extends Controller
{
  ...
  public function edit_category($cat_id)
	...
	public function save_subcategory(Request $request)
	{
		...
		$data = array('cat_id' => $category_id, 'parent_id'=>$parent_id, 'subcategory_name' => $subcategory_name, 'subcategory_slug' => $subcategory_slug, 'subcategory_status' => $subcategory_status);
