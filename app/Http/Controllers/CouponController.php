...
class CouponController extends Controller {
	...
	public function view_coupon() {
		...
		return view('theme2.coupon', ['couponData' => $couponData]);
	}

	public function add_coupon() {
		return view('theme2.add-coupon');
	}
	...
	public function save_coupon(Request $request) {
		...
		$rules = array(
			'coupon_code' => ['required',  Rule::unique('coupon')->where(function ($sql) {
				$sql->where('coupon_id', '!=', '');
			})],
		);
	...
	public function edit_coupon($coupon_id) {
		...
		return view('theme2.edit-coupon', ['edit' => $edit]);
	}
	...
	public function update_coupon(Request $request) {
		...
		$rules = array(
			'coupon_code' => ['required',  Rule::unique('coupon')->ignore($coupon_id, 'coupon_id')->where(function ($sql) {
				$sql->where('coupon_status', '!=', '');
			})],
